...
interface QuinaStatisticsProps {
  mostFrequentNumbers?: number[];
  evenOddDistribution?: { even: number; odd: number };
  highLowDistribution?: { high: number; low: number };
}

const QuinaStatistics = ({
  mostFrequentNumbers = [5, 12, 23, 34, 47, 58, 69, 72, 80],
  evenOddDistribution = { even: 48, odd: 52 },
  highLowDistribution = { high: 45, low: 55 },
}: QuinaStatisticsProps) => {
  return (
    <section className="w-full py-8 bg-background">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-[#9C27B0] to-[#2196F3]">
          Estatísticas da Quina Analisadas por IA
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 md:px-0 max-w-5xl mx-auto">
          ...
          <Card className="bg-card">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <BarChart className="h-5 w-5 text-[#660099]" />
          ...
          <Card className="bg-card">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <PieChart className="h-5 w-5 text-[#660099]" />
            ...
            <CardContent>
              <div className="h-[180px] flex items-center justify-center">
                <div className="relative w-[150px] h-[150px] md:w-[180px] md:h-[180px] rounded-full overflow-hidden">
                  <div
                    className="absolute bg-gradient-to-r from-[#4B0082] to-[#660099] h-full"
                    style={{ width: `${evenOddDistribution.even}%` }}
                  ></div>
                  <div
                    className="absolute bg-gradient-to-r from-[#9C27B0] to-[#BA68C8] h-full right-0"
          ...
          <Card className="bg-card">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <LineChart className="h-5 w-5 text-[#660099]" />
            ...
            <CardContent>
              <div className="h-[180px] flex items-center justify-center">
                <div className="relative w-[150px] h-[150px] md:w-[180px] md:h-[180px] rounded-full overflow-hidden">
                  <div
                    className="absolute bg-[#660099] h-full"
                    style={{ width: `${highLowDistribution.low}%` }}
                  ></div>
                  <div
                    className="absolute bg-[#9C27B0] h-full right-0"
        ...
        <div className="mt-8 max-w-4xl mx-auto px-4 md:px-0">
          <div className="p-6 border rounded-lg bg-card">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <h3 className="font-bold text-lg mb-2 text-[#660099]">
...
export default QuinaStatistics;
